...
$routes->get('admin/product/habis/edit/(:num)', 'Product::tambah/$1', ['filter' => 'role:admin']);
...
$routes->get('/transaction/edit1/(:segment)', 'Transaction::edit1/$1', ['filter' => 'role:admin']);
$routes->get('/transaction/edit2/(:segment)', 'Transaction::edit2/$1', ['filter' => 'role:admin']);
$routes->get('/transaction/edit3/(:segment)', 'Transaction::edit3/$1', ['filter' => 'role:admin']);
$routes->get('/transaction/edit4/(:segment)', 'Transaction::edit4/$1', ['filter' => 'role:admin']);
$routes->get('/transaction/edit5/(:segment)', 'Transaction::edit5/$1', ['filter' => 'role:admin']);
