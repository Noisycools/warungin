                            ...
                            <tbody>
                                ...
                                <?php foreach ($transaksi->getResult('array') as $t) : ?>
                                    <tr>
                                        ...
                                        <td><span class="badge bg-warning"><?= $t['status']; ?></span>
                                            <a type="submit" href="/transaction/update_pending/<?= $t['kode_transaksi']; ?>" class="badge btn-outline-primary btn-sm"><i class="fa fa-check"></i></a></td>
