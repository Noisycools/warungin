  ...
  <div class="container px-5 py-24 mx-auto" x-data="{ inputQuantity: 1, warning: false }">
    ...
    <div class="lg:w-4/5 mx-auto flex flex-wrap">
      ...
      <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
        <h2 class="text-sm title-font text-gray-300 tracking-widest"><?= strtoupper($barang['kategori_barang']); ?></h2>
        <h1 class="text-white text-3xl title-font font-bold mb-1"><?= $barang['nama_barang']; ?></h1>
        <div class="flex mb-4"></div>
        <p class="leading-relaxed">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Dolorum provident ab ullam sunt praesentium deleniti nam ad? Quisquam corrupti excepturi tenetur iste officia, illo eos ex molestiae repellendus, laboriosam dolor.</p>
